...
class Server
{
    ...
    {
        $host = $this->container['config']->get('jsonrpc.server.host');
        $port = $this->container['config']->get('jsonrpc.server.port');
    ...
    {
        $config = $this->container['config']->get('jsonrpc.server.options');
